...
function NavBar({searchComponent}) {
  ...
  return (
    <>
      ...
      <div className="stickly top-0 z-10">
        <div className="flex gap-5 items-center justify-between mt-4 max-w-full mx-10">
          <NavLink to="/"><div className="flex items-center justify-center gap-2 text-white text-2xl"><span> <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" className="bi bi-camera-reel fill-white" viewBox="0 0 16 16">
          ...
          <div className=" text-white flex gap-10 justify-center items-center">
            <NavLink to="/" className={({ isActive }) =>
              isActive ? "text-white font-semibold" : "text-[#b8b8b8] hover:text-neutral-400 hover:cursor-pointer"
            }>Home</NavLink>
